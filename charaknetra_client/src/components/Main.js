...
export default function Main(props) {
  ...
  return (
    <div className="container text-center  mt-3 mb-5" style={{backgroundColor:'black'}}>
      <Link to="uploadfiles">
        <button style={{ width: '30%' }} className="btn btn-lg btn-outline-warning mt-4 mb-2">Upload Files Now!</button>
      </Link>
      <div className="row" style={{backgroundColor:'black'}}>
        <div className="col" style={{ borderRadius: 10 , backgroundColor:'black'}}>
                    ...
                    allFiles.map((file, key) => {
                      return (
                        <tr>
                          ...
                          <td style={{ width: '12%' }}><a href={"https://projectphase3.infura-ipfs.io/ipfs/" + file.fileHash} rel="noopener noreferrer" target="_blank" className="btn btn-primary">View</a></td>
                          <td style={{ width: '8%' }}>
