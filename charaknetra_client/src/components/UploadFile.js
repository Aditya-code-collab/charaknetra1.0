         ...
         <div class="m-5">
           ...
           <div className={`mx-5 text-start text-light ${showFileDetails ? "" : "d-none"}`} id="fileDetailsBox">
             ...
             <div class="col-12 mt-2">
               <label for="fileDesBox" class="form-label">Diabetes Report</label>
               <input type="text" value={data} class="form-control" maxLength="200" id="fileDesBox" placeholder="type file Description here " />
             </div>
